...
;P5.c,20 :: 		void interrupt(){
;P5.c,21 :: 		key=tecla();
	CALL        _tecla+0, 0
	MOVF        R0, 0 
	MOVWF       _key+0 
;P5.c,22 :: 		Lcd_chr(1,1, key);
	MOVLW       1
	...
	CALL        _Lcd_Chr+0, 0
;P5.c,23 :: 		x=PORTB; //hay que leer el puerto B para poder borrar el bit RBIF (define x global)
	MOVF        PORTB+0, 0 
	MOVWF       _x+0 
;P5.c,24 :: 		INTCON.RBIF=0;//Al borrar el bit RBIF despues de llamar a la funcion tecla, nos
	BCF         INTCON+0, 0 
;P5.c,27 :: 		}
L_end_interrupt:
L__interrupt15:
...
;P5.c,29 :: 		void main() {
;P5.c,30 :: 		TRISB=0xF0;  //el nibble alto son entradas y el nibble bajo son salidas
	MOVLW       240
	MOVWF       TRISB+0 
;P5.c,31 :: 		PORTB=0;
	CLRF        PORTB+0 
;P5.c,33 :: 		TRISD=0;
	CLRF        TRISD+0 
;P5.c,36 :: 		INTCON2.RBPU=0; //se habilitan las resistencias de pullup de las entradas del PORTB
	BCF         INTCON2+0, 7 
;P5.c,37 :: 		x=PORTB;//para poder borrar el RBIF
	MOVF        PORTB+0, 0 
	MOVWF       _x+0 
;P5.c,38 :: 		INTCON.RBIF=0;
	BCF         INTCON+0, 0 
;P5.c,39 :: 		INTCON.RBIE=1;
	BSF         INTCON+0, 3 
;P5.c,40 :: 		INTCON.GIE=1;
	BSF         INTCON+0, 7 
;P5.c,41 :: 		Lcd_Init ();
	CALL        _Lcd_Init+0, 0
;P5.c,42 :: 		while(1);
